...
class SmallAnalogClockWidget extends StatelessWidget {
  final double dateFontSize;
  const SmallAnalogClockWidget({
    Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    double clockSize = 250.0;
    double hourHandLength = 40.0;
    double minuteHandLength = 60.0;
    double secondHandLength = 70.0;
