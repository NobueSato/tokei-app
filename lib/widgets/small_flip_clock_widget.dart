...
class SmallFlipClockWidget extends StatefulWidget {
  final double dateFontSize;
  final double amPmFontSize;
  const SmallFlipClockWidget({
    super.key,
  ...
  @override
  State<SmallFlipClockWidget> createState() => _FlipClockWidgetState();
}

class _FlipClockWidgetState extends State<SmallFlipClockWidget>
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                          height:
                              baseSize * 0.7), // Adjust this space as needed
                      // PM Text
                      Container(
          ...
          Row(
            ...
            children: [
              FittedBox(
                fit: BoxFit.scaleDown,
                child: SizedBox(
                  width: widget.amPmFontSize * 1.7, // Ensure consistent width
                  child: Container(
                    color: isDebugging ? Colors.pink : Colors.transparent,
